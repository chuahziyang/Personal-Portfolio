...
const props = defineProps({
  ...
  successMessage: {
    type: String,
    default:
      "Email sent Successfully! Will get back to you in a few days time.",
  },
  failureMessage: {
    type: String,
    default:
      "Oops. Something went wrong. Send me an email at czyang2002@gmail.com instead",
  },
});
...
<template>
  <div
    ...
    v-bind:class="mapping[success].background"
  >
    <div class="flex">
